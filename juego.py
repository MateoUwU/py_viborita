...
class Juego:
    ...
    def iniciar(self):
        ...
        self.musica.pausar()
        self.mostrar_mensaje("Presiona ENTER para jugar", 50, ANCHO / 2, ALTO / 2)
    ...
    def finalizar(self):
        self.sonido.reproducir("recursos/crash.mp3")
        self.VENTANA.fill(COLOR_FONDO)

        self.mostrar_mensaje("JUEGO FINALIZADO", 70, ANCHO / 2, ALTO / 2 - 50)
    ...
    def actualizar(self):
        ...
        if self.hay_colision(self.serpiente.x[0], self.serpiente.y[0], self.manzana.x, self.manzana.y):
            ...
            self.sonido.reproducir("recursos/ding.mp3")
